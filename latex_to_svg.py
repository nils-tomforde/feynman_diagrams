...
def mpl_generate_latex(formula: str,
                       fontsize: float = 12,
                       color_rgb_256: tuple[float, float, float] = (0, 0, 0)) -> str:
...
def latex_to_svg(formula: str,
                 ...
                 phi: float = 0,
                 center_x: bool = True,
                 center_y: bool = True) -> xml_handler.Tag:
    ...
    latex_tag = xml_handler.Tag(tag_name="g", attributes=attributes, content="",
                                children=root_tag.children, is_empty=False)
